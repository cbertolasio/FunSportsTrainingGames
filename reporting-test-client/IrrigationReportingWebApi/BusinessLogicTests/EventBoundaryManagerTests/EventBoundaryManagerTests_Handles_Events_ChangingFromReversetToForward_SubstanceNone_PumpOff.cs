...
{
	[TestFixture]
	public class EventBoundaryManagerTests_Handles_Events_ChangingFromReversetToForward_SubstanceNone_PumpOff
	{
		[Test]
		public void GetEventBoundaries_Finds_Correct_StartBoundary_When_TestData_HasPrevious_Data()
		{
			var testData = SingleEventBoundaryTestData.GetData_ChangingFrom_Reverse_To_Forward().ToArray();
		...
		[Test]
		public void GetEventBoundaries_Finds_Correct_StartBoundary_When_TestData_HasNoPrevious_Data()
		{
			var testData = SingleEventBoundaryTestData.GetData_ChangingFrom_Reverse_To_Forward().ToList();
			testData.RemoveAt(0);
		...
		{
			var testData = SingleEventBoundaryTestData.GetData_ChangingFrom_Reverse_To_Forward();
