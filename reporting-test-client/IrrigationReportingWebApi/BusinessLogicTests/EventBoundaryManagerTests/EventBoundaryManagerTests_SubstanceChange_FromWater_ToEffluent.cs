...
{
	[TestFixture]
	public class EventBoundaryManagerTests_SubstanceChange_FromWater_ToEffluent
	{
		/// <summary>
		...
		{
			var testData = MultiEventBoundaryTestData.GetDataWithSubstanceChangedFromWaterToEffluent().ToArray();
		...
		{
			var testData = MultiEventBoundaryTestData.GetDataWithSubstanceChangedFromWaterToEffluent().ToList();
		...
		{
			var testData = MultiEventBoundaryTestData.GetDataWithSubstanceChangedFromWaterToEffluent();
		...
		public void GetEVentBoundaries_Sets_Substance_To_Fertigation()
		{
			...
			var expected = IrrigationEventsManager.EffluentSubstanceValue;
