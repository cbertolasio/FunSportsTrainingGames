...
{
	[TestFixture]
	public class EventBoundaryManagerTests_Increasing_Speed
	{
		/// <summary>
		...
		{
			var testData = MultiEventBoundaryTestData.GetDataWithIncreasingSpeedChange().ToArray();
		...
		{
			var testData = MultiEventBoundaryTestData.GetDataWithIncreasingSpeedChange().ToList();
		...
		{
			var testData = MultiEventBoundaryTestData.GetDataWithIncreasingSpeedChange();
			...
			Assert.AreEqual(40.0, expected, "PRECON");
